...
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | Nazwa grupy zasobów, w której powstanie AKS | `string` | n/a | yes |
...
| <a name="output_cluster_id"></a> [cluster\_id](#output\_cluster\_id) | ID zasobu klastra AKS w Azure heh |
